  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        <div className="absolute inset-0 transform -skew-x-12 origin-top bg-gradient-to-r from-[#4285F4] to-[#3C83F9]" />
        <div className="relative z-20 font-bold flex items-center text-lg ">
          LOGO
        </div>
        <div className="relative z-20 mt-[40vh] ml-24 text-7xl font-bold">
          Board.
        </div>
        <div className="relative z-20 mt-auto">
          <div className="flex gap-6 px-20 pb-2 items-center">
            <svg
              width="45"
              height="44"
              viewBox="0 0 45 44"
      ...
      <div className="bg-[#F8FAFF] flex flex-col justify-center ">
        <div className="mx-auto">
          ...
          <div className="flex gap-3 py-9">
            <button
              ...
              className="bg-white hover:bg-gray-100 text-[#858585]  gap-2 py-1 px-4 rounded-lg inline-flex items-center">
              <FcGoogle />
              <span>Sign in with Google</span>
            </button>
          </div>
          <form className="max-w-[400px] w-full   px-8 pt-6 pb-8 mb-4 bg-white rounded-lg">
            ...
            <button className="border w-full my-5 py-2 rounded-lg bg-blue-500 hover:bg-indigo-500 text-white font-semibold">
              Sign In
            </button>
          </form>
          <div className="mt-2">
